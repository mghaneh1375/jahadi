...
public class Utility {
    ...
    public static final Pattern datePattern2 = Pattern.compile(
            "^[1-4]\\d{3}-(([1-6]-((3[0-1])|([1-2][0-9])|([1-9])))|((1[0-2]|([7-9]))-(30|([1-2][0-9])|([1-9]))))$"
    );
    public static final Pattern persianDateTimePattern = Pattern.compile(
            "^[1-4]\\d{3}-((0[1-6]-((3[0-1])|([1-2][0-9])|(0[1-9])))|((1[0-2]|(0[7-9]))-(30|([1-2][0-9])|(0[1-9])))) - ([01][0-9]|2[0-3]):([0-5][0-9])$"
    );

    public static final Pattern persianDateTimePattern2 = Pattern.compile(
            "^[1-4]\\d{3}-(([1-6]-((3[0-1])|([1-2][0-9])|([1-9])))|((1[0-2]|([7-9]))-(30|([1-2][0-9])|([1-9])))) - ([01][0-9]|2[0-3]):([0-5][0-9])$"
    );
